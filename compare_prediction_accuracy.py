...
# Example usage
main_folder_path = r"C:\Users\geosaad\Desktop\Main-Scripts\SpindleModelWeights_compare\Spindle-Prediction-Compare\MM_25Hz-50Hz_0.5Hz-24HzEEG"
os.chdir(main_folder_path)

plot_mismatches('post-1100_predictions.csv', 'post-1100.csv')
...
# Example usage
output_excel_path = os.path.join(main_folder_path, "mismatches_summary.xlsx")
save_mismatches_to_excel('post-1100_predictions.csv', 'post-1100.csv', output_excel_path)
def analyze_mismatches(prediction_file, label_file, output_file):
    ...
    mismatch_percentages = (mismatch_counts / total_counts) * 100
...
# Example usage
output_excel_path = os.path.join(main_folder_path, "mismatches_analysis.xlsx")
analyze_mismatches('post-1100_predictions.csv', 'post-1100.csv', output_excel_path)